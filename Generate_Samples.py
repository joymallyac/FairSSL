...
def generate_samples(no_of_samples,df,df_name):
    ...
    if df_name == 'Adult':
        final_df = final_df.rename(columns={0:"age", 1:"education", 2:"education-num", 3:"occupation", 4:"race", 5:"sex", 6:"capital-gain", 7:"capital-loss", 8:"hours-per-week", 9:"Probability"}, errors="raise")
    if df_name == 'Compas':
    ...
    if df_name == 'German':
        final_df = final_df.rename(columns={0:"sex",1:"age",2:"credit_history=Delay",3:"credit_history=None/Paid",4:"credit_history=Other",5:"savings=500+",6:"savings=<500",7:"savings=Unknown/None",8:"employment=1-4 years",9:"employment=4+ years",10:"employment=Unemployed",11:"Probability"}, errors="raise")
    if df_name == 'Heart':
    ...
    if df_name == 'Student':
        final_df = final_df.rename(columns={0:'sex', 1:'age', 2:'Medu', 3:'Fedu', 4:'traveltime', 5:'studytime', 6:'failures',7:'schoolsup', 8:'famsup', 9:'paid', 10:'activities', 11:'nursery', 12:'higher', 13:'internet', 14:'romantic', 15:'famrel', 16:'freetime', 17:'goout', 18:'Dalc', 19:'Walc', 20:'health', 21:'absences', 22:'G1', 23:'G2', 24:'Probability'}, errors="raise")
    if df_name == 'MEPS16':
        final_df =final_df.rename(columns={0: 'REGION', 1: 'AGE', 2: 'SEX', 3: 'race', 4: 'MARRY', 5: 'FTSTU', 6: 'ACTDTY', 7: 'HONRDC', 8: 'RTHLTH', 9: 'MNHLTH', 10: 'HIBPDX', 11: 'CHDDX', 12: 'ANGIDX', 13: 'MIDX', 14: 'OHRTDX', 15: 'STRKDX', 16: 'EMPHDX', 17: 'CHBRON', 18: 'CHOLDX', 19: 'CANCERDX', 20: 'DIABDX', 21: 'JTPAIN', 22: 'ARTHDX', 23: 'ARTHTYPE', 24: 'ASTHDX', 25: 'ADHDADDX', 26: 'PREGNT', 27: 'WLKLIM', 28: 'ACTLIM', 29: 'SOCLIM', 30: 'COGLIM', 31: 'DFHEAR42', 32: 'DFSEE42', 33: 'ADSMOK42', 34: 'PCS42', 35: 'MCS42', 36: 'K6SUM42', 37: 'PHQ242', 38: 'EMPST', 39: 'POVCAT', 40: 'INSCOV', 41: 'PERWT16F', 42: 'Probability'},errors='raise')
    if df_name == 'MEPS15':
        final_df =final_df.rename(columns={0: 'REGION', 1: 'AGE', 2: 'SEX', 3: 'race', 4: 'MARRY', 5: 'FTSTU', 6: 'ACTDTY', 7: 'HONRDC', 8: 'RTHLTH', 9: 'MNHLTH', 10: 'HIBPDX', 11: 'CHDDX', 12: 'ANGIDX', 13: 'MIDX', 14: 'OHRTDX', 15: 'STRKDX', 16: 'EMPHDX', 17: 'CHBRON', 18: 'CHOLDX', 19: 'CANCERDX', 20: 'DIABDX', 21: 'JTPAIN', 22: 'ARTHDX', 23: 'ARTHTYPE', 24: 'ASTHDX', 25: 'ADHDADDX', 26: 'PREGNT', 27: 'WLKLIM', 28: 'ACTLIM', 29: 'SOCLIM', 30: 'COGLIM', 31: 'DFHEAR42', 32: 'DFSEE42', 33: 'ADSMOK42', 34: 'PCS42', 35: 'MCS42', 36: 'K6SUM42', 37: 'PHQ242', 38: 'EMPST', 39: 'POVCAT', 40: 'INSCOV', 41: 'PERWT15F', 42: 'Probability'}, errors="raise")
